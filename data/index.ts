...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a AI Podcast App",
...
export const projects = [
  ...
  {
    id: 3,
    title: "BidPark - Blog App for StartUp",
...
export const workExperience = [
  ...
  {
    id: 3,
    title: "Full Stack Development with NextJS",
  ...
  },
  {
    id: 4,
    title: "Web Design",
    desc: "Designed a modern web app using figma for better user experience and developed web app.",
    className: "md:col-span-2", 
    thumbnail: "/exp2.svg",
  },
];
